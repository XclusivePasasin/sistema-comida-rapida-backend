...
class DishController extends Controller
{
    ...
    public function showDishes()
    {
        try {
            ...
            if ($dishes->count() == 0) {
                ...
                return response()->json(
                    ['code' => 200, 'message' => 'Dishes found', 'dishes' => $dishes], 200
                );
            }
            }
        catch (Exception $e) {
    ...
    public function createDish(Request $request)
    {
        try {
            ...
            return response()->json(
                ['code' => 201, 'message' => 'Dish created', 'dish' => $dish], 201
            );
        }
        catch (Exception $e) {
            return response()->json(
    ...
    public function updateDish(Request $request)
    {
        try {
            ...
            return response()->json(
                ['code' => 200, 'message' => 'Dish updated', 'dish' => $dish], 200
            );
        }
        catch (Exception $e) {
            return response()->json(
    ...
    public function deleteDish(Request $request)
    {
        try {
            ...
            $dish->delete();
            return response()->json(
                ['code' => 200, 'message' => 'Dish deleted', 'dish' => $dish], 200
            );
        }
        catch (Exception $e) {
            return response()->json(
